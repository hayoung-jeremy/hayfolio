...
export default function QM6_Decal({ ...props }: any) {
  const group = useRef<THREE.Group>(null);
  const { nodes, materials } = useGLTF("/api/model-url?name=QM6/QM6_Decal.glb") as any;

  const pattern_motorsport = useLoader(TextureLoader, "/api/model-url?name=QM6/QM6_Decal_stripe.png");
  const pattern_offroad = useLoader(TextureLoader, "/api/model-url?name=QM6/QM6_Decal_triangle.png");
  const pattern_futuristic = useLoader(TextureLoader, "/api/model-url?name=QM6/QM6_Decal_hexagon.png");
