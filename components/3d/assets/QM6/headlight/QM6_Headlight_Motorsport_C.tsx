...
export default function QM6_Headlight_Motorsport_C(props: any) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Motorsport_C_1.geometry}
        material={materials.light_darkmetal}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Motorsport_C_2.geometry}
        material={materials.light_led}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Motorsport_C_3.geometry}
        material={materials.light_matte}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Motorsport_C_4.geometry}
