...
export default function QM6_Headlight_Offroad_B(props: any) {
  ...
  return (
    <group {...props}>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Offroad_B_1.geometry}
        material={materials.light_darkmetal}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Offroad_B_2.geometry}
        material={materials.light_led}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Offroad_B_3.geometry}
        material={materials.light_matte}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.QM6_Headlight_Offroad_B_4.geometry}
